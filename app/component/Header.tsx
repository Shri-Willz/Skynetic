...
export default function Header({ mounted }: { mounted: boolean }) {
  ...
  return (
    <header
      className={`
        relative z-40 flex flex-col md:flex-row 
        justify-between items-start md:items-center 
        mb-10 gap-4 transition-all duration-700
    ...
    >
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="hidden md:block text-sm font-bold text-slate-700 group-hover:text-indigo-700 transition-colors">
                Alex
              </span>
              <ChevronDown
                size={16}
      ...
      <div className="relative w-full md:max-w-md md:order-1 group">
        ...
        <input
          ...
          className="
            w-full pl-12 pr-4 py-3.5 bg-white border border-slate-200/60 
